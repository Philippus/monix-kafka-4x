...
/** The compression type for all data generated by the producer, the `compression.type` from the Kafka Producer
  * configuration.
  *
  * The default is none (i.e. no compression). Compression is of full batches of data, so the efficacy of batching will
