...
/** Wraps a Kafka `Serializer`, provided for convenience, since it can be implicitly fetched from the context.
  ...
  *
  * @param constructor
  *   creates an instance of [[classType]]. This is defaulted with a `Serializer.Constructor[A]` function that creates a
  *   new instance using an assumed empty constructor. Supplying this parameter allows for manual provision of the
  *   `Serializer`.
  */
...
object Serializer {
  ...
  /** Alias for the function that provides an instance of the Kafka `Serializer`.
    */
